...
public class ESClientDaoImpl implements ESClientDao {
	...
	@Override
	public SearchTemplateResponse searchTemplate(SearchTemplateRequest searchTemplateRequest, RequestOptions requestOptions) {
		CompletableFuture<SearchTemplateResponse> cf = new CompletableFuture<>();
		restHighLevelClient.searchTemplateAsync(searchTemplateRequest, requestOptions, new ActionListener<SearchTemplateResponse>() {
